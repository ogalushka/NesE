...
{
    public class ROLTest : BaseCPUTest
    {
        public ROLTest()
        {
            CPU.RAM[0] = OP.ROL_ACC;
        }
        ...
        private class TestData : IEnumerable<object[]>
        {
            ...
            {
                yield return new object[] { OP.ROL_ACC, (Action<byte, CPU>)MemorySetter.Accumulator, (Func<CPU, byte>)MemoryGetter.Accumulator };
                yield return new object[] { OP.ROL_ZEP, (Action<byte, CPU>)MemorySetter.ZeroPage, (Func<CPU, byte>)MemoryGetter.ZeroPage };
                yield return new object[] { OP.ROL_ZPX, (Action<byte, CPU>)MemorySetter.ZeroPageX, (Func<CPU, byte>)MemoryGetter.ZeroPageX };
                yield return new object[] { OP.ROL_ABS, (Action<byte, CPU>)MemorySetter.Absolute, (Func<CPU, byte>)MemoryGetter.Absolute };
                yield return new object[] { OP.ROL_ABX, (Action<byte, CPU>)MemorySetter.AbsoluteX, (Func<CPU, byte>)MemoryGetter.AbsoluteX };
            }
